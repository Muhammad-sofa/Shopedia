...
@section('content')
<nav class="section-content section-dashboard-home" data-aos="fade-up">
                                        ...
                                        <div class="row">
                                             <div class="col-md-6">
                                                  <div class="form-group">
                                                       ...
                                                       <input type="text" class="form-control" id="name" name="name" value="Sofa">
                                                  </div>
                                             </div>
                                             <div class="col-md-6">
                                                  <div class="form-group">
                                                       <label for="email">Your Email</label>
                                                       <input type="email" class="form-control" id="email" name="email" value="muhammadsofa52@gmail.com">
                                                  </div>
                                             </div>
                                             <div class="col-md-6">
                                                  <div class="form-group">
